...
QMAKE    = /usr/bin/qmake
Freak_My_Logs.xcodeproj/project.pbxproj: my_wol.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o Freak_My_Logs.xcodeproj/project.pbxproj my_wol.pro
