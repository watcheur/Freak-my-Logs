...
QMAKE    = /usr/bin/qmake
my_wol.xcodeproj/project.pbxproj: my_wol.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o my_wol.xcodeproj/project.pbxproj my_wol.pro
